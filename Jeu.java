...
public class Jeu {
	...
	public void creerListePerso(){
		...
		Personnage p3 = new Personnage("BOULARD Solenn","femme","ondulés","chatains","bleus",im3, "rien", "Guadeloupe");
		...
		Personnage p8 = new Personnage("DRUTEL Maxence","homme","lisses","chatains","marrons foncés",im8, "rien", "France");
		ListePersonnage.add(p8);
		ImageIcon im9 = new ImageIcon("/Users/alainboulard/Desktop/photos ajustée algo/10 DAGHNI Samya.png");
		Personnage p9 = new Personnage("DAGHNI Samya","femme","bouclés","bruns","marrons clairs",im9, "rien", "Maroc");
		...
		Personnage p11 = new Personnage("GOMINSKI Benjamin","homme","lisses","blonds","bleus",im11, "rien", "France");
		...
		Personnage p12 = new Personnage("GRANGE Quentin","homme","lisses","chatains","marrons clairs",im12, "lunettes", "France");
		...
		Personnage p18 = new Personnage("ROUSSI Emmanuelle","femme","bouclés","noirs","marrons",im18, "sa beauté", "Mada");
		...
		Personnage p20 = new Personnage("SIMONNET Léa","femme","bouclés","chatains","marrons clairs",im20, "rien", "France");
