...
public class Jeu {
	...
	public void creerListePerso(){
        ...
        ImageIcon im19 = new ImageIcon(new ImageIcon("../Multimedia/photos_classe/22 SANDOZ Alexandre.png").getImage().getScaledInstance(175,160, Image.SCALE_DEFAULT)) ; 
		...
		ImageIcon im20 = new ImageIcon("../Multimedia/photos_classe/23 SIMONNET Léa.png");
		Personnage p20 = new Personnage("SIMONNET Léa","femme","bouclés","chatains","marrons",im20, "rien", "France");
		listePersonnage.add(p20);
		ImageIcon im21 = new ImageIcon("../Multimedia/photos_classe/24 VARGAS Diego.png");
